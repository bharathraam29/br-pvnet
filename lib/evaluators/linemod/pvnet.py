...
# Comment out nn_utils import as we'll use numpy instead
# from lib.csrc.nn import nn_utils

def find_nearest_point_idx(points1, points2):
    """Simple nearest neighbor implementation using scipy"""
...
class Evaluator:
    ...
    def add_metric(self, pose_pred, pose_targets, icp=False, syn=False, percentage=0.1):
        ...
        if syn:
            # Use our simple nearest neighbor implementation instead of nn_utils
